  ...
  const s=showSearch?`
    <div class="search-wrap">
      <div class="search-bar">
        ...
        <input type="text" id="searchInput" placeholder="Cari lagu..." autocomplete="off" oninput="onSearch(this.value)"/>
...
function toggleSidebar(){
  ...
  hb.style.transform=document.getElementById('sidebar').classList.contains('open')?'rotate(90deg)':'';
}
